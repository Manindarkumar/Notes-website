                    ...
                    <form action="savestudent.php" method="post" enctype="multipart/form-data">
                        ...
                        <center>
                            <div id="ac">
                                ...
                                <span
                                    style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Student
                                    ID : </span><input type="text" style="width:265px; height:30px;" value="MS17-<?php 
$prefix= md5(time()*rand(1, 2)); echo strip_tags(substr($prefix ,0,4));?>" name="student_id" readonly Required /><br>
                                <span
                                    style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">First
                                    Name : </span><input type="text" style="width:265px; height:30px;" name="name"
                                    Required /><br>
                                <span
                                    style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Last
                                    Name : </span><input type="text" style="width:265px; height:30px;" name="last_name"
                                    Required /><br>
                                <span
                                    style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Gender
                                    : </span>
                                ...
                                <span
                                    style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Date
                                    of Birth : </span><input type="date" style="width:265px; height:30px;" name="dob"
                                    required /><br>
                                <span
                                    style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Academic
                                ...
                                <span
                                    style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Admission
                                ...
                                <span
                                    style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Parent
                                    Phone : </span> <input type="text" style="width:265px; height:30px;" name="parent"
                                    required />
                                <br>
                                <span
                                    style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Report
                                    : </span><textarea style="width:265px; height:50px;" name="report"></textarea><br>
                                <span
                                    style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Passport
                                    : </span><input type="file" name="file" id="file" required

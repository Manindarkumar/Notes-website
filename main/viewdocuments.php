...
">
                ...
                <table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
                    <thead>
                        <tr>
                            ...
                            <th width="10%" style="background-color: #518fd6;;">
                                <center> Title </center>
                            </th>
                            <th width="35%" style="background-color: #518fd6;;">
                                <center> Description</center>
                            </th>
                            <th width="20%" style="background-color: #518fd6;;">
                                <center> File</center>
                            </th>
			...
			?>
                        ...
                        <td><a title="Download Document" href="../documents/<?php echo $row['doc_file'];?>"
                                download><button class="btn btn-success btn-mini"
                                    style="width: 102px;margin-left: 10px;height: 35px;font-size: 15px;"><i
                                        class="icon-download"></i> Download</button> </a>
                            <a title="View Document" href="../documents/<?php echo $row['doc_file'];?>"
                                TARGET="_blank"><button class="btn btn-success btn-mini"
                                    style="width: 102px;margin-left: 10px;height: 35px;font-size: 15px;"><i
